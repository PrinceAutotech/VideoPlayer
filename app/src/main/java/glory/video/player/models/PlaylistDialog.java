...
import static glory.video.player.activities.VideoFilesActivity.MY_PREF;
...
public class PlaylistDialog extends BottomSheetDialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        SharedPreferences preferences = this.requireActivity().getSharedPreferences(MY_PREF, Context.MODE_PRIVATE);
    ...
    private ArrayList<MediaFiles> fetchMedia(String folderName) {
        ...
        Cursor cursor = requireContext().getContentResolver().query(uri, null,
